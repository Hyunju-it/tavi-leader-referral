...
export const commands = {
  ...
  epilogue: {
    ...
    execute: () => {
      const messages = [
        "[01] 선배님의 새로운 여정의 시작을 진심으로 축하드립니다.",
        "[02] 다양한 과정을 겪으면서 고생하시는 모습을 보고, 옆에서 진심으로 걱정 많이했습니다.",
        "[03] 그 과정에서 때로는 부족한 점에 마음이 더 쏠리기도 하지만, 사실 이미 충분히 큰 강점들을 지니고 계심을 잊지 않으셨으면 합니다.",
        "[04] 저는 가까이에서 선배님이 얼마나 뛰어난 역량과 책임감을 보여주셨는지를 계속 보아왔습니다.",
        "[05] 선배님은 이미 충분히 대단한 분이고, 이번 경험들은 앞으로 더 큰 가능성을 쌓아가는 밑거름이 될 것이라 믿습니다.",
        "[06] 다른 사람도 언젠가 이 멋진 점을 알아봐주길 바라며 진심을 다해서 만들었습니다.",
        "",
        "◆ 언제나 응원하고 있습니다 ◆",
        "",
        "[ TMI ]",
